  ...
  return (
    <section id="for-healthcare" className="bg-mist">
      <Container>
        ...
        <div className="grid grid-cols-1 items-stretch gap-6 pb-12 lg:grid-cols-[minmax(0,0.94fr)_minmax(0,1fr)] lg:pb-14 xl:grid-cols-[minmax(0,0.79fr)_minmax(0,1fr)]">
          <LiveActivity />
          <Integrations />
        </div>
      </Container>
